...
transformed_data$Tenure <- as.numeric(Sys.Date() - as.Date(transformed_data$JoinDate))
transformed_data$JoinDate <- NULL
transformed_data$Recency <- as.numeric(Sys.Date() - as.Date(transformed_data$LastLoginDate))
